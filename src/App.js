...
export const StyledButton = styled.button`
  ...
  border-radius: 50px;
  border: none;
  background-color: rgb(131 157 167 / 7%);
  padding: 10px;
  font-weight: bold;
  color: #e4e4e4;
  width: 156px;
...
export const StyledImg = styled.img`
  box-shadow: rgb(119 185 179 / 70%) 0px 5px 11px 2px;
  border: 5px dashed rgba(126, 126, 126, 0);
  background-color: rgb(79 79 79 / 35%);
  border-radius: 100%;
  width: 368px;
      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          >
            ...
            >
             <s.TextSubTitle color: "var(--accent-text)">size={5}>{1111-supply} of 1111 NFT's Available</s.TextSubTitle>
            </s.TextTitle>
            <s.TextDescription
              style={{
                textAlign: "center",
